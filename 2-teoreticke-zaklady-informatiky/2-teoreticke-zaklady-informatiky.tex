...
\begin{figure}[ht]
\centering\includegraphics[width=8cm]{img/vychodilovoVajicko}
...
\begin{center}
\centering\includegraphics[width=8cm]{img/reg1}
\end{center}

Když tento automat zdeterminizujeme, dostaneme následující automat:

\begin{center}
\centering\includegraphics[width=8cm]{img/reg2}
\end{center}
...
\begin{center}
\centering\includegraphics[width=8cm]{img/reg3}
\end{center}
...
\begin{center}
\centering\includegraphics[width=8cm]{img/reg4}
\end{center}
...
\begin{figure}[H]
\centering\includegraphics[width=7cm]{img/ZA}
...
\begin{figure}[ht]
\centering\includegraphics[width=7cm]{img/ZA2}
