...
Chomského hierarchie. Věta o rekurzi.
	...
	\subsection{Částečně rekurzivní a rekurzivní jazyky, Jazyky a rozhodovací problémy, Vztah rekurzivních a částečne rekurzivních jazyků }
		...
		\begin{figure}[!h]
		\centering
		\includegraphics[width=12cm]{jazykyAJejichDoplnky.png}	
	...
	\subsection{Vztah jazyků TS k jazykům Chomského hierarchie}
		...
		\begin{figure}[!h]
		\centering
		\includegraphics[width=8cm]{chomskyVSts.png}			
		\end{figure}
...
její vztah k třídám P a NP, PSPACE-úplné problémy. Třídy N a NL a NL-úplné problémy.
	...
	Omezujeme se na logaritmickou paměťovou složitost ze stejného důvodu, jako jsme se předtím omezili na
	 polynomickou časovou složitost: problémy řešitelné v logaritmické paměti považujeme za řešitelné efektivně.
		...
		\begin{figure}[!h]
		\centering
		\includegraphics[width=13cm]{prepisovac.png}			
		\end{figure}

		\begin{figure}[!h]
		\centering
		\includegraphics[width=13cm]{NLuplny.png}			
		\end{figure}
...
do Prologu.
	...
	\subsection{Výroková Logika}
		...
		\subsubsection{jazyk}
			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{jazykVL.png}			
			\end{figure}

			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{formuleVL.png}			
			\end{figure}
 		\newpage
		\subsubsection{pravdivostní ohodnocení}
			...
			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{pravdivostniOhodnoceniVL.png}			
			\end{figure}

			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{ohodnoceniFormule.png}			
			\end{figure}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{tautologie.png}			
			\end{figure}
 
		\subsubsection{tabulková metoda}
			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{tabulkovaMetoda.png}			
			\end{figure}
		...
		\subsubsection{sémantické vyplývání}
			...
			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{semantickeVyplyvani.png}			
			\end{figure}
		...
		\subsubsection{normální formy formulí}
			...
			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{UKNF.png}			
			\end{figure}

			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{vetaUKNF.png}			
			\end{figure}

			\begin{figure}[!h]
			\centering
			\includegraphics[width=13cm]{prikladUKNF.png}			
			\end{figure}
		...
		\subsubsection{úplné systémy spojek}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{uplneSystemySpojek.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{uplneSystemySpojek2.png}			
			\end{figure}
		...
		\subsubsection{axiomatický systém výrokové logiky}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=12cm]{MP.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=12cm]{axiomy.png}			
			\end{figure}
		...
		\subsubsection{syntaktické výplývání}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=12cm]{dukaz.png}			
			\end{figure}
		...
		\subsubsection{Věta o dedukci}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{VoD.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{VoDpriklad.png}			
			\end{figure}
		...
		\subsubsection{Věty o korektnosti a úplnosti výrokové logiky}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{VoK.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{VoKpoznamka.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{VoU.png}			
			\end{figure}
	...
	\subsection{Predikátová logika}
		...
		\subsubsection{jazyk}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{JazykPL.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{JazykPL2.png}			
			\end{figure}
		...
		\subsubsection{termy a formule}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{termy.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{formulePL.png}			
			\end{figure}
		...
		\subsubsection{struktury pro jazyk}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{stukturaProJazyk.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{strukturaProJazyk.png}			
			\end{figure}
		...
		\subsubsection{ohodnocení termu a formulí}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{ohodnoceniPL.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{mOhodnoceni.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{ohodnoceniFormuliPL.png}			
			\end{figure}
		...
		\subsubsection{axiomatický systém predikátové logiky}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{axiomyPL.png}			
			\end{figure}
		...
		\subsubsection{syntaktické vyplývání}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{semantickeVyplyvaniPL.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{syntaktickeVyplyvaniPL.png}			
			\end{figure}
		...
		\subsubsection{věty o korektnosti a úplnosti predikátové logiky}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{VoKPL.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{VoUPL.png}			
			\end{figure}
	...
	\subsection{Neklasické logiky}
		...
		\subsubsection{fuzzy logika}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{fuzzy1.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{fuzzy2.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{fuzzy3.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{fuzzy4.png}			
			\end{figure}
	...
	\subsection{Základy logického programování, úvod do Prologu}
			...
			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog1.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog2.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog3.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog4.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog5.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog6.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog7.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog8.png}			
			\end{figure}

			\begin{figure}[H]
			\centering
			\includegraphics[width=13cm]{prolog9.png}			
			\end{figure}
