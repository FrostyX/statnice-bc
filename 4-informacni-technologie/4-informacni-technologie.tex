...
\begin{figure} [h]
		\includegraphics[scale=0.6]{architektura_jadra.png}
...
\begin{enumerate}
	...
	\item Operační systém - privilegovaný režim, přístup z vyšších vrstev pouze skrze \textbf{SYSTÉMOVÉ VOLÁNÍ}
...
\begin{figure} [h]
		\includegraphics[scale=0.8]{vrstvy_HW-SW.png}
...
\begin{figure} [h]
		\includegraphics[scale=0.8]{stavy_procesu.png}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{figure} [h]
			\includegraphics[scale=0.6]{alokacni_graf_a_graf_cekani.png}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\end{itemize}
			\begin{figure} [h]
				\includegraphics[scale=0.6]{bankeruv_algoritmus.png}
...
v množství použité paměti)
	...
	\begin{figure} [h]
		\includegraphics[scale=1]{virtualni_pamet.png}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{figure} [h]
			\includegraphics[scale=0.8]{inode.png}
			\caption{inode}	
		\end{figure}
	\end{itemize}
\end{itemize}
...
\textbf{ŽURNÁLOVÁNÍ}
\begin{itemize}
	\item data se zapisují v transakcích (přsun FS z jednoho konzistentního stavu do druhého)
...
bezpečnost a není potřeba obnovovat strukturu FS
	...
	\item cache & buffery komplikují implementaci atomických zápisů na disk
\end{itemize}
...
změněna metadata
	\begin{figure} [h]
		\includegraphics[scale=0.7]{konzistence.png}
